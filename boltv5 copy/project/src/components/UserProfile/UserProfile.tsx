        ...
        <div className="group h-8 w-8">
          {picture ? (
            <img 
              src={picture} 
              alt="Profile" 
              className="h-8 w-8 rounded-full object-cover border-2 border-purple-200 transform transition-transform duration-200 group-hover:scale-110"
            />
          ) : (
            <User className="h-8 w-8 p-1 rounded-full bg-purple-100 text-purple-600 transform transition-transform duration-200 group-hover:scale-110" />
          )}
        </div>
