...
import { suggestedContent } from '../../data/mockData';
      ...
      <div className="space-y-3">
        {suggestedContent.map((content) => (
          <a 
            key={content.id}
            href={content.url}
            className="flex items-center justify-between p-3 rounded-md hover:bg-gray-50 transition-colors border border-gray-100 hover:border-gray-200"
          >
