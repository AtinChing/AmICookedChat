    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-900 to-indigo-900 text-white">
      ...
      <nav className="container mx-auto px-6 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold">MindMend.ai</span>
          </div>
        </div>
      </nav>
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl mb-12 text-purple-100 leading-relaxed">
            Your personal AI-powered assistant for maintaining focus, tracking productivity,
            and achieving mental wellness in the digital age.
          </p>
      ...
      <footer className="container mx-auto px-6 py-8 mt-20">
        <div className="text-center text-purple-200 text-sm">
          © 2025 MindMend.ai • All rights reserved
        </div>
      </footer>
    </div>
  );
